...
class ShadowRemovalDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.transform:
            shadow_img, shadow_free_img = self.transform(shadow_img, shadow_free_img)
        ...
        return shadow_img, shadow_free_img
...
class Compose(object):
    ...
    def __call__(self, shadow_img, shadow_free_img):
        
        for aug in self.augmentations:
            shadow_img, shadow_free_img = aug(shadow_img, shadow_free_img)
...
class RandomCrop(object):
    ...
    def __call__(self, shadow_img, shadow_free_img):
        ...
        x = random.randint(0, shadow_img.shape[1] - self.width)
        y = random.randint(0, shadow_img.shape[0] - self.height)
