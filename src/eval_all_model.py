...
def eval_model(eval_type='best'):
    ...
    for m in best_models:
        # pass
        os.system('./run.sh --load_model --gpu_id 0 --model_name {} --lrG {} --lrD {} --batch_size_test {} --root_dir {} --dataset_name {}'.format(m, args.lrG, args.lrD, args.batch_size_test, args.root_dir, args.dataset_name))
...
if __name__ == "__main__":
    args = get_args()
    path = PathHandler(args.root_dir, task='stcgan_lrG_{}_lrD_{}'.format(args.lrG, args.lrD), data=args.dataset_name)
