...
def get_args():
    ...
    parser.add_argument('--hist_step', default=10, type=int, help='every # steps record training statistic')
    parser.add_argument('--test_step', default=100, type=int, help='every # steps to validation')
    parser.add_argument('--model_step', default=1000, type=int, help='every # steps save model')
